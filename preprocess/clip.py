...
class CLIP:
    def __init__(self, model_path="stabilityai/japanese-stable-clip-vit-l-16", device='cuda'):
    ...
    def get_image_features(self, images: List[str]):
...
if __name__=='__main__':
    ...
    image_features = clip.get_image_features([Image.open(os.path.join(data_dir, f'旭山動物園_{i}.jpg')) for i in range(20)])
