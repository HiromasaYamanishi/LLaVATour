...
deepspeed --include localhost:5 llava/train/train_mem.py \
    ...
    --model_name_or_path lightblue/qarasu-14B-chat-plus-unleashed \
    --version v1 \
    --data_path ./playground/data/jalan_tourism_with_review.json \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-qwen-14b-jalan-review-lora \
    --num_train_epochs 1 \
